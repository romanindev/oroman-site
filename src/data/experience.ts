...
export const experienceEntries: ExperienceEntry[] = [
  {
    ...
    responsibilities: [
      ...
      'Owned the end-to-end delivery of product features, from requirements analysis and technical design through implementation, testing, release coordination, and production validation.',
      'Made technical decisions on implementation strategy and system design, evaluating trade-offs, defining integration approaches, and ensuring solutions were scalable, maintainable, and aligned with business requirements.',
      'Owned the complete onboarding of a new brand onto the platform, covering UI adaptation, backend service changes, database migrations, automated test coverage, end-to-end testing, release preparation, and production rollout.',
      'Introduced React Query as the standard solution for server-state management, reducing duplicate API requests by approximately 30% through caching, request deduplication, and structured query invalidation.',
      'Contributed to frontend and backend architecture, defining API integration patterns, request lifecycle handling, error-management strategies, data flows, and reliability improvements for business-critical functionality.',
      'Established engineering quality standards by introducing ESLint, Prettier, Husky, and automated pre-commit checks for a team of 15 engineers, reducing formatting-related review feedback and improving consistency across the codebase.',
      'Conducted code reviews and participated in technical interviews, helping evaluate candidates, support knowledge sharing, and maintain engineering standards across the team.',
      'Expanded automated test coverage for more than 15 critical business flows, improving release confidence and reducing the risk of production regressions.',
      'Integrated AWS services including S3 and EC2 into application development and deployment workflows, supporting production infrastructure and feature delivery.',
