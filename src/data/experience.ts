...
export const experienceEntries: ExperienceEntry[] = [
  {
    ...
    responsibilities: [
      'Modernized a large React/TypeScript codebase by refactoring legacy components, improving architecture, extending state management with Redux Toolkit, and introducing reusable UI patterns across 35+ modules.',
      'Migrated more than 60% of legacy components and UI flows to a Figma-based design system, improving UI consistency and reducing duplicated implementation effort.',
      'Introduced ESLint, Prettier, and Husky for a team of 15 engineers, standardizing code quality and significantly reducing formatting-related review comments.',
      'Introduced React Query for server-state management, reducing duplicate API requests by approximately 30% through caching, request deduplication, and query invalidation.',
      'Used Claude Code to support legacy code analysis, refactoring, documentation, and code review, accelerating investigation and implementation of complex features.',
      'Contributed to frontend and backend architecture decisions, helping define API integration patterns, request lifecycle handling, and reliability improvements.',
      ...
      'Added automated test coverage for 15+ critical business flows, improving release confidence and reducing regression-related issues in production.',
    ],
    skills: [
      'React',
      'TypeScript',
