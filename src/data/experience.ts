...
export const experienceEntries: ExperienceEntry[] = [
  {
    ...
    responsibilities: [
      ...
      'Introduced React Query as the standard server-state solution, reducing duplicate API requests by approximately 30% through caching, request deduplication, and structured query invalidation.',
      'Improved engineering quality and developer experience for a team of 15 engineers by introducing ESLint, Prettier, Husky, and automated pre-commit checks; also conducted code reviews and participated in technical interviews.',
